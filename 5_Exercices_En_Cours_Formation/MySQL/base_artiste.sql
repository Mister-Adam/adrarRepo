...
insert into role_utilisateur (nom_role_utilisateur)
values ("utilisateur"),("artiste"),("admin");


insert into utilisateur(nom_utilisateur,prenom_utilisateur,
 email_utilisateur, password_utilisateur, statut_utilisateur, id_role_utilisateur)
values ("Chirac","Jacques", "jc@elysee.fr", "maman", 0,3),
("Sarkozy", "Nicolas", "nettoyer@karcher.fr", "vousfumez",1,3),
("Hallyday","Johnny", "salut@monpote.fr", "akekoukou",0,2),
("Honnet","Andreas", "sardo@sel.fr", "ctsurenfait",1,1);

insert into groupe(nom_groupe)
values ("peinture"),("vidéo"),("dessin");

insert into categorie(nom_categorie)
values ("new"),("actualite"),("oeuvre");

-- insert into article(titre_article,date_article,statut_article,contenu_article,id_categorie,id_utilisateur)
-- values (

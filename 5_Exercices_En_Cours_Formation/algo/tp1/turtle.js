...
if (canvas && canvas.getContext) { // does the browser support 'canvas'?
	...
	turtle.ct.fillRect(0,0,1000,600);
} else {
...
// tried to make drawing speed gradual

// turtle.forward = function(length) {
// 	let x0 = this.x,
// 		y0 = this.y,
// 		distance = 0,
// 		step = 1, // Drawing speed
// 		dx = (length / 100) * step * Math.sin(this.angleInRadians), 
// 		dy = (length / 100) * step * Math.cos(this.angleInRadians),
// 		interval = 1; // Delay between each step in ms
